...
@Component({
  ...
  standalone: true,
  imports: [
    MatDialogModule, MatFormFieldModule,MatNativeDateModule, CommonModule, MatInputModule, FormsModule, MatButtonModule, MatSelectModule, MatOptionModule,MatDatepickerModule
  ],
